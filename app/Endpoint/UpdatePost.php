...
class UpdatePost extends AbstractEndpoint
{
    ...
    public function v1Action(Request $request): Response
    {
        ...
        if (!$postId) {
            throw APIException::HTTPError(Response::HTTP_STATUS_BAD_REQUEST, 'id field required');
        }
        ...
        $timeline->editPost($user, $postId, $text);
